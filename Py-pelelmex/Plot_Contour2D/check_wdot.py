...
fn_derived = os.path.join(data_folder, "Slice2D_derived_lev1/MicroMix_age/Derived_y=9.000E-04/plt_14600_derived_t=9.208E-04.npz")
fn_plt     = os.path.join(data_folder, "Slice2D_plt_lev1/Micromix_age/HRR_T_y=9.000E-04/plt_14600_t=9.208E-04.npz")
